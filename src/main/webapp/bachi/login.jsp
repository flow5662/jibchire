...
<body>
	<div id="wrap">
		...
		<form method="post" action="loginSelect.jsp"
			onsubmit="return loginChk()">

			<section>
				<div id="login">
					<div id="mainTitle">로그인</div>
					<div id="subTitle">
					...
					<div id="forgot">
						<a href="#아이디찾기">아이디 찾기 ㅣ </a> <a href="#비번찾기">비밀번호 찾기</a>
					</div>
					<input type="submit" value="로그인">

					<div class="sns-login">
						<a href="#카카오로그인"><img
							src="img/login/kakao_login_medium_narrow.png" /></a> <a
							href="#네이버로그인"><img src="img/login/naver_login.png"
							style="width: 180px; height: 45px;" /></a>
					</div>
				</div>
			</section>
